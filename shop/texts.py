...
TEXTS = {
    "uk": {
        ...
        "review_required": "⭐️ <b>Залишився один крок</b>\n\n"
                           "Щоб продовжити, оцініть попереднє замовлення. "
                           "Коментар і фото — за бажанням.",
        ...
        "referral_joined_notice": "🤝 <b>Новий реферал</b>\n\n"
                           ...
                           "Він зарахується, щойно зробить замовлення.",
        "referral_purchase": "🛒 <b>Покупка вашого реферала</b>\n\n"
                           "<b>{who}</b> придбав: {product}\n\n"
    ...
    "ru": {
        ...
        "review_required": "⭐️ <b>Остался один шаг</b>\n\n"
                           "Чтобы продолжить, оцените предыдущий заказ. "
        ...
        "referral_joined_notice": "🤝 <b>Новый реферал</b>\n\n"
                           ...
                           "Он засчитается, как только сделает заказ.",
        "referral_purchase": "🛒 <b>Покупка вашего реферала</b>\n\n"
                           "<b>{who}</b> купил: {product}\n\n"
