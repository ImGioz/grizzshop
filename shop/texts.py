...
TEXTS = {
    "uk": {
        ...
        "payment_details": "<b>Спосіб оплати: переказ на картку</b>\n\n"
                           ...
                           "Після оплати надішліть посилання на квитанцію Monobank "
                           "(вигляду https://check.monobank.ua/p/...).\n"
                           "Оплатіть протягом {timeout} хв.",
    ...
    "ru": {
        ...
        "payment_details": "<b>Метод оплаты: перевод на карту</b>\n\n"
                           ...
                           "После оплаты пришлите ссылку на квитанцию Monobank "
                           "(вида https://check.monobank.ua/p/...).\n"
                           "Оплатите в течение {timeout} мин.",
